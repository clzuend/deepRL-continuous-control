...
WEIGHT_DECAY_AC = 0     # L2 weight decay for the actor
WEIGHT_DECAY_CR = 0     # L2 weight decay for the critic
...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, num_agents = 1, 
        ...
        self.actor_local = Actor(state_size, action_size, random_seed, hidden_sizes_actor).to(device)
        self.actor_target = Actor(state_size, action_size, random_seed, hidden_sizes_actor).to(device)
        self.actor_optimizer = optim.Adam(self.actor_local.parameters(), 
                                          lr=LR_ACTOR, weight_decay=WEIGHT_DECAY_AC)
